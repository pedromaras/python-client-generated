...
class MoviesApiApi(object):
    ...
    def a_pi_buscar_api_key_expression_get(self, api_key, expression, **kwargs):  # noqa: E501
        """a_pi_buscar_api_key_expression_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_buscar_api_key_expression_get(api_key, expression, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.a_pi_buscar_api_key_expression_get_with_http_info(api_key, expression, **kwargs)  # noqa: E501
        else:
            (data) = self.a_pi_buscar_api_key_expression_get_with_http_info(api_key, expression, **kwargs)  # noqa: E501
            return data

    def a_pi_buscar_api_key_expression_get_with_http_info(self, api_key, expression, **kwargs):  # noqa: E501
        """a_pi_buscar_api_key_expression_get  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.a_pi_buscar_api_key_expression_get_with_http_info(api_key, expression, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method a_pi_buscar_api_key_expression_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'api_key' is set
        if ('api_key' not in params or
                params['api_key'] is None):
            raise ValueError("Missing the required parameter `api_key` when calling `a_pi_buscar_api_key_expression_get`")  # noqa: E501
        # verify the required parameter 'expression' is set
        if ('expression' not in params or
                params['expression'] is None):
            raise ValueError("Missing the required parameter `expression` when calling `a_pi_buscar_api_key_expression_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/API/Buscar/{apiKey}/{expression}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
